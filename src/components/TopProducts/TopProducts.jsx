          ...
          {ProductsData.map((data) => (
            ...
            >
              ...
              <div className="h-[100px]">
                ...
                group-hover:scalw-105 duration-300 drop-shadow-md "
                />
              </div>
              {/* details section */}
              <div className="p-4 text-center">
                {/* star rating */}
                <div className="w-full flex item-center justyfy-center gap-1">
                ...
                <p className="text-gray-500 ground-hover:text-white 
                duration-300 text-sm line-clamp-2">
                    {data.description}
                </p>
                <button className="bg-primary hover:scale-105 
                duration-300 text-white py-1 px-4 rounded-full mt-4 ground-hover:bg-white
                ground-hover:text-primary">
                    Order Now
                </button>
              </div>
            </div>
